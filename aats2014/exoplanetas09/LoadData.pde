...
void loadData() {
  int rowCount = 0;
  //para llenar valores de posx para bolas
    ...
    for (TableRow row : losDatos.rows()) {
      ...
      planets[rowCount] = new Planet(data_p_discovered, data_p_mass, data_p_mass, data_p_radius, 500, data_p_discovered, data_p_name, data_s_name, data_s_radius );
